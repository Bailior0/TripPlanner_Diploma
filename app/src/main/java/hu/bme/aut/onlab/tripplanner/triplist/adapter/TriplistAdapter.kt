...
class TriplistAdapter(private val listener: TriplistItemClickListener) :
    ...
    /*@DrawableRes()
    private fun getImageResource(category: WatchlistItem.Category): Int {
        return when (category) {
            WatchlistItem.Category.ACTION -> R.drawable.action
            WatchlistItem.Category.ANIMATION -> R.drawable.animation
            WatchlistItem.Category.COMEDY -> R.drawable.comedy
            WatchlistItem.Category.DRAMA -> R.drawable.drama
            WatchlistItem.Category.HORROR -> R.drawable.horror
            WatchlistItem.Category.MYSTERY -> R.drawable.mystery
            WatchlistItem.Category.ROMANCE -> R.drawable.romance
            WatchlistItem.Category.SCIFI -> R.drawable.scifi
            WatchlistItem.Category.THRILLER -> R.drawable.thriller
        }
    }*/
    ...
    interface TriplistItemClickListener {
        ...
        fun onTripSelected(name: String?, description: String?)
    }
